...
**Live dashboard**: _link added after first deployment_
...
Full model documentation — assumptions, formulas, known limitations — in
[docs/methodology.md](docs/methodology.md) (also rendered on the dashboard's Methodology
page). Highlights:
